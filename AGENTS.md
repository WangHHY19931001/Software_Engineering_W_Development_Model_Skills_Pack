...
门禁脚本测试：
- `w-model-dev/scripts/__tests__/`：门禁脚本单元测试（vitest，40 个 .test.ts / 623 条）
...
| self-test.ts | 回归基线（254 条样本）；vitest 623 条（40 test files） | - | 0=通过，1=失败 |
