...
门禁脚本测试：
- `w-model-dev/scripts/__tests__/`：门禁脚本单元测试（vitest，44 个 .test.ts / 701 条）
...
| self-test.ts | 回归基线（256 条样本）；vitest 701 条（44 test files） | - | 0=通过，1=失败 |
