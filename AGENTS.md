...
门禁脚本测试：
- `w-model-dev/scripts/__tests__/`：门禁脚本单元测试（vitest，50 个 .test.ts / 808 条）
...
| self-test.ts | 回归基线（256 条样本）；vitest 808 条（50 test files） | - | 0=通过，1=失败 |
