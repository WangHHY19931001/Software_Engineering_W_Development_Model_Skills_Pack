...
门禁脚本测试：
- `w-model-dev/scripts/__tests__/`：门禁脚本单元测试（vitest，54 个 .test.ts / 875 条）
...
| self-test.ts | 回归基线（260 条样本）；vitest 875 条（54 test files） | - | 0=通过，1=失败 |
