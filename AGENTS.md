...
门禁脚本测试：
- `w-model-dev/scripts/__tests__/`：门禁脚本单元测试（vitest，55 个 .test.ts / 942 条）
...
| self-test.ts | 回归基线（260 条样本）；vitest 942 条（55 test files） | - | 0=通过，1=失败 |
