...
- **D7C 同步 D7A/D7B 后真实 Vitest 计数**：以仓库外受控 coverage/provenance artifact 实测的 54 test files / 897 tests / 897 passed / 0 failed / success=true 为唯一来源，同步允许活体文档、pre-push 第 12 项描述性计数与 docs-consistency fixture；不改变 D7A/D7B 逻辑、hook 控制流或 evidence export。
