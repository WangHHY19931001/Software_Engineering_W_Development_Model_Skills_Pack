...
2026-09-04 对 42.2.1 域 13 条留档项（最终独立审查 2 条 parked Minor P1/P2 + 账本 11 条延后 Minor D1-D11）逐条处置、全部可追溯：P1/P2 与 D1-D10 已修复；D11（台账收尾）即本段——父链追加行覆盖本战役任务 1/2 已存在提交、前注与范围句刷新至合并前 tip 的父提交，本追加提交自身按规则不入链。详细设计与逐条处置见规格 `docs/superpowers/specs/2026-09-04-archival-fixes-design.md`；版本保持 42.2.1，不 bump。
