 ...
 *
 * 系统测试与集成测试的差异：
 * - 集成测试聚焦 INTF 间协同，使用 setupIntegrationTest
 * - 系统测试聚焦端到端流程、性能/安全/可靠性
 * - 同一 setup 可复用，因 module-level 单例都被 reset
 */
...
export function setupSystemTest(): SystemContext {
