...
- [所属系统](#所属系统)
- [公理](#公理)
- [§1 BDD 分层架构](#1-bdd-分层架构)
- [§2 features 文件结构与头标注契约](#2-features-文件结构与头标注契约)
- [§3 状态机七要素约束](#3-状态机七要素约束)
- [§4 BDD↔TLA+ 协作](#4-bddtla-协作)
- [§5 门禁脚本调用](#5-门禁脚本调用)
- [§6 8 阶段产出时序](#6-8-阶段产出时序)
- [§7 验收夹具四类设计](#7-验收夹具四类设计)
- [§8 不符处理流程](#8-不符处理流程)
- [§9 TLA+/BDD 自动化同步校验](#9-tlabdd-自动化同步校验)
- [语法速查](#语法速查)
- [模式与示例](#模式与示例)
- [评审清单](#评审清单)
