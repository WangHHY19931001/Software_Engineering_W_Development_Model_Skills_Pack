...
3. **Persona 可引用技能内容**：Persona 在评审中可加载 [verifier-spec.md](verifier-spec.md) §8 提示词模板、[quick-self-check.md](quick-self-check.md)「完成定义（DoD）」节 DoD 标准、[quality-standards.md](quality-standards.md) 质量标准作为「如何做」的依据。
