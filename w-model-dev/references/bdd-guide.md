...
> **TLA+ L4 说明**：TLA+ 分层为 L1-L3 + 按需 L4（递归拆解，阶段 4 按需，见 [tla-plus-guide.md](tla-plus-guide.md)）。BDD L4 与 TLA+ L4 同层对应（都到原子方法）；未产出 TLA+ L4 时，BDD L4 与 TLA+ L3 的最细粒度（原子方法级）对齐。
