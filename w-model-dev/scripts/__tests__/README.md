...
| bdd-cli.test.ts | BDD CLI | phase 1-4 `--require-tla-equivalence` 缺证据 D4 exit 1 / 真实 TLA+ 快照等价路径 / phase 5-8 `--require-cucumber-report` 缺证据 D5 exit 1 / 正常 cucumber 报告 / 错误 phase 组合 exit 2 / 兼容跳过诊断 / pre-push fixture 与项目阶段门文档边界 |
