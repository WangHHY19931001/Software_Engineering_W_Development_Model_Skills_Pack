...
const REQUIRED_PATHS = [
  ...
  'w-model-dev/references/quick-self-check.md',
  'w-model-dev/references/conventions.md',
...
async function main(): Promise<void> {
  ...
  const input: DocConsistencyInput = {
    ...
    schemaInventoryDocs: [
      ...
      { name: 'hard-constraints.md（反模式节）', content: read('w-model-dev/references/hard-constraints.md') },
    ...
    dispatchMatrix: read('w-model-dev/references/subagent-delegation.md'),
    readme: read('README.md'),
    agents: read('AGENTS.md'),
    ssot: read('docs/skill-design-document_SSoT.md'),
    rootCauseAuthoritySpec: read('w-model-dev/references/agent-personas.md'),
