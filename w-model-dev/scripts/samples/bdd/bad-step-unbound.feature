# features/L1/L1_blog_system-001.feature (sample - bad-step-unbound)
# 此 feature 文件结构合法，但其 step 文本在 step_definitions 中无对应绑定。
# self-test 中通过注入 cucumberReport={undefinedCount:1} 模拟 cucumber 运行结果，触发 D5。
# @req: REQ-001
# @design: SD-3.2.1
