...
> 设计 spec：[2026-08-10-mythical-man-month-absorption-design.md](./superpowers/specs/2026-08-10-mythical-man-month-absorption-design.md)（已批准，P1 批已实施（39.1.0））。本轮吸收源为《agent 时代的人月神话》（Brooks《人月神话》2026 年逐章重写，19 章）；对技能包做 26 项概念覆盖审计后，按 P0→P2 分三批吸收。**纯文档为主 + 少量脚本联动**（反模式计数 44→46），不新增子流程/门禁脚本/并行轨，self-test 基线不变。
...
| self-test | 基线 249 不变 |
| 版本号 | 39.1.0（P1 批，三处一致；P2→39.2.0 排期） |
