...
| 负面知识库（47 条反模式 + 教训）                                                             | [../w-model-dev/references/hard-constraints.md](../w-model-dev/references/hard-constraints.md)                                                                                                                    |
| JSON Schema 文件（draft-07，25 份，含 change-scope / codegraph-query 与 evidence-manifest / evidence-provenance）              | [../w-model-dev/schemas/](../w-model-dev/schemas)                                                                                                                                                           |
