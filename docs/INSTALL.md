...
| JSON Schema 文件（draft-07，21 份） | [../w-model-dev/schemas/](../w-model-dev/schemas) |
...
- **devDep（测试）**：`vitest` + `@vitest/coverage-v8`（`w-model-dev/scripts/__tests__/` 单元测试，52 个 test 文件 / 833 条）
